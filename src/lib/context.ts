...
/**
 * Loads the AI runtime context for a request by combining:
 * 1) global knowledge files, 2) blog discovery index, and 3) optional current page context.
 *
 * @param params.pageContext Optional page-specific context generated by the current route.
 * @returns A sectioned context string consumed by the API prompt.
 * @throws When any knowledge source fails to load.
 */
